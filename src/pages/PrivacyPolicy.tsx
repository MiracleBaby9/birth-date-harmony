...
const PrivacyPolicy = () => (
  <div className="min-h-screen bg-brand-bg">
    <div className="container max-w-3xl py-12 px-4">
      ...
      <h1 className="text-3xl md:text-4xl font-display text-brand-heading mb-2">Privacy Policy</h1>
      ...
      <div className="prose prose-sm max-w-none font-body text-brand-body space-y-6">
        ...
        <h2 className="text-xl font-display text-brand-heading">1. Information We Collect</h2>

        <h3 className="text-lg font-display text-brand-heading">Personal Information You Provide:</h3>
        ...
        <h3 className="text-lg font-display text-brand-heading">Automatically Collected Information:</h3>
        ...
        <h3 className="text-lg font-display text-brand-heading">Payment Information:</h3>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <h2 className="text-xl font-display text-brand-heading">2. How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">3. How We Share Your Information</h2>
        <p>We DO NOT sell, rent, or trade your personal information to third parties.</p>
        <p>We may share your information only in the following circumstances:</p>

        <h3 className="text-lg font-display text-brand-heading">Service Providers:</h3>
        ...
        <h3 className="text-lg font-display text-brand-heading">Legal Requirements:</h3>
        <p>If required by law, court order, or government authority.</p>

        <h3 className="text-lg font-display text-brand-heading">Business Transfers:</h3>
        <p>In the event of a merger, acquisition, or sale of assets (users will be notified).</p>

        <h2 className="text-xl font-display text-brand-heading">4. Data Security</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">5. Data Retention</h2>
        <ul className="list-disc pl-6 space-y-1">
        ...
        <h2 className="text-xl font-display text-brand-heading">6. Your Rights</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">7. Cookies and Tracking</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">8. Third-Party Links</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">9. Children's Privacy</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">10. International Users</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">11. Changes to Privacy Policy</h2>
        ...
        <h2 className="text-xl font-display text-brand-heading">12. Contact Us</h2>
