    ...
    >
      <div className="container flex items-center justify-between gap-3 py-2.5 sm:py-3">
        ...
        <a
          ...
          className="max-w-[46vw] rounded-full bg-brand-rose px-4 py-2 text-center text-sm font-body font-semibold leading-snug text-white transition-transform hover:scale-105 hover:bg-brand-rose-dark sm:max-w-none sm:px-5"
        >
          Perfect Baby Name
        </a>
      </div>
